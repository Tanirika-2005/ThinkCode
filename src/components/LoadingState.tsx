...
export function LoadingState() {
  return (
    <div 
      className="absolute inset-0 bg-gray-50 flex flex-col items-center justify-center z-30" 
      role="status" 
      aria-live="polite"
      aria-label="Loading bus tracking data"
    >
      {/* Enhanced loading spinner with better contrast */}
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-lg text-gray-900 font-medium text-center">
          Loading Bus Tracking
        </h2>
      </div>
      
      {/* Secondary message with better contrast */}
      ...
      <div className="sr-only" aria-live="assertive">
        Loading bus tracking system. Please wait while we fetch real-time transit data.
      </div>
    </div>
  );
}